        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header">
              <strong>Thêm mới</strong> Users
            </div>
            <div class="card-body card-block">
              <form action="{{route('khachhangs.insert')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                @csrf
                ...
                @if(Session::has('thanhcong'))
                  ...
                  <div>
                    <a href="{{route('admins.index')}}"><button>danh muc admin</button></a>
                  </div>
                @else
                {{-- tên tài khoản--}}
                <div class="row form-group">
