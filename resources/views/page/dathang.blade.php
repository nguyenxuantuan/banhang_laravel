...
<form action="{{route('home.xacnhandathang')}}" method="post" class="beta-form-checkout">
			@csrf
								...
								<div class="your-order-item">
									...
									<!--  one item	 -->
										...
										<img width="25%" src="source/image/product/{{$sanpham->options->image}}" class="pull-left" >
											...
											<br><br>
											<div><span class="color-gray your-order-info">Số lượng : {{$sanpham->qty}}*{{$sanpham->price}}
												VND</span>
											</div>
										</div>
									<!-- end one item -->
								...
								<ul class="payment_methods methods">
									...
									<li class="payment_method_cheque">
										...
										<div class="payment_box payment_method_cheque" style="display: none;">
											...
											<br>- Ngân hàng TPBank , Chi nhánh PHAM HUNG
										</div>
									</li>
				...
				<div class="text-center"><button class="btn btn-success" id="submit" type="submit" name="submit"> Đặt hàng <i class="fa fa-chevron-right"></i></button></div>
						</div> <!-- .your-order -->
					</div>
				</div>
			</form>
